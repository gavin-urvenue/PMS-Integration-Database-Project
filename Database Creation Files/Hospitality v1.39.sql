...
-- -----------------------------------------------------
-- Table `pms_db`.`SERVICESlibFolioOrdersType`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pms_db`.`SERVICESlibFolioOrdersType` ;

CREATE TABLE IF NOT EXISTS `pms_db`.`SERVICESlibFolioOrdersType` (
  `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `status` TINYINT NULL DEFAULT 7,
  `rndCode` VARCHAR(24) NULL DEFAULT '',
  `createTStamp` INT UNSIGNED NULL DEFAULT 0,
  `modTStamp` INT UNSIGNED NULL DEFAULT 0,
  `orderType` VARCHAR(32) NULL DEFAULT '',
  `metaData` JSON NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `pms_db`.`SERVICESfolioOrders` (
  ...
  `transferisOnArrival` TINYINT NULL DEFAULT 0,
  ...
  `libFolioOrdersTypeId` BIGINT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_SERVICESfolioorders_SERVICESlibserviceitems1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SERVICESfolioOrders_SERVICESfolioOrdersType1`
    FOREIGN KEY (`libFolioOrdersTypeId`)
    REFERENCES `pms_db`.`SERVICESlibFolioOrdersType` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_SERVICESfolioOrders_SERVICESfolioOrdersType1_idx` ON `pms_db`.`SERVICESfolioOrders` (`libFolioOrdersTypeId` ASC) VISIBLE;
