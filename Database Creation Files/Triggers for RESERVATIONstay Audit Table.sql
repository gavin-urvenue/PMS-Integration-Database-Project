...
DROP TRIGGER IF EXISTS after_insert_RESERVATIONstay;
DROP TRIGGER IF EXISTS after_update_RESERVATIONstay;
DROP TRIGGER IF EXISTS before_delete_RESERVATIONstay;
